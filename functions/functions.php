...
<div class='alert alert-danger alert dismissible' role='alert'>
	<button type='button' class='close' data-dismiss='alert' aria-label='close'><span aria-hidde='true'>&times;</span></button><strong>Warning!</strong> 
	$error_message
</div>
delimiter;
...
function register_user($first_name, $last_name, $username, $email, $password){
	...
	if(email_exists($email)){
		...
		http://localhost/secureLoginAndRegSystem/activate.php?email=$email&code=$validation_code";

		$headers = "From: noreply@securelogin.com";
...
function recover_password() {
	...
	if($_SERVER['REQUEST_METHOD'] == "POST") {
		...
		if(isset($_SESSION['token']) && $_POST['token'] == $_SESSION['token']) {
			...
			Click here to reset your password http://localhost/secureLoginAndRegSystem/code.php?email=$email&code=$validation_code";
			$headers = "From: noreply@securelogin.com";
